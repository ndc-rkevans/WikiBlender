...
<html>
  ...
  <body>
	...
	<p id="subtitle" style='font-size: 2.1em;'>
		<a href='https://revansx.net/social/'><span style='font-weight:bold;border:1px solid #e0e0e0;border-radius:9px;background-color:#f0f0f0;'>/Social/</span></a>
		&nbsp;
		<a href='https://revansx.net/photos/'><span style='font-weight:bold;border:1px solid #e0e0e0;border-radius:9px;background-color:#f0f0f0;'>/Photos/</span></a>
		&nbsp;
	  	<a href='https://revansx.net/learn/'><span style='font-weight:bold;border:1px solid #e0e0e0;border-radius:9px;background-color:#f0f0f0;'>/Learing/</span></a>
		&nbsp;
		<span style='font-weight:bold;border:1px solid #e0e0e0;border-radius:9px;'>Wikis (see below)</span>
    <div id="container">
